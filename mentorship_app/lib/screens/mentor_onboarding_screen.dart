...
class MentorOnboardingScreen extends StatefulWidget {
  const MentorOnboardingScreen({Key? key}) : super(key: key);
...
class _MentorOnboardingScreenState extends State<MentorOnboardingScreen> {
  ...
  Future<void> _saveAndContinue() async {
    ...
    try {
      ...
      if (uid == null) {
        throw Exception("currentUser.uid is null! User session lost before saving Mentor Skills.");
      }
      print('DEBUG: [Get Current User for Mentor Skills] Successful');
      ...
      await FirebaseFirestore.instance.collection('users').doc(uid).set({
        ...
        throw Exception('Network timeout: Could not save skills and bio. Please check your connection.');
      });
      print('DEBUG: [Save Mentor Skills] Successful');
      if (mounted) context.go('/onboarding/preferences');
    } catch (e, stackTrace) {
      print('ERROR: Failed at [Save Mentor Skills] - $e');
            ...
            children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: AntigravityTheme.electricPurple.withOpacity(0.5),
                            blurRadius: 10,
                          ),
                        ],
                      ),
              ...
              GlassContainer(
                child: TextField(
                  ...
                  style: const TextStyle(color: AntigravityTheme.textPrimary, fontSize: 18),
                  decoration: InputDecoration(
                    hintText: 'e.g. React Native, Node.js, Agile...',
                    hintStyle: TextStyle(
                      color: AntigravityTheme.textSecondary.withOpacity(0.5),
                      fontSize: 16,
                    ),
    ...
    return Material(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: AntigravityTheme.softBlue.withOpacity(0.6),
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
              color: AntigravityTheme.softBlue.withOpacity(isDragging ? 0.6 : 0.3),
